/*
  ...
  - A unique constraint covering the columns `[emailId]` on the table `token` will be added. If there are existing duplicate values, this will fail.
...
-- CreateIndex
CREATE UNIQUE INDEX "token_emailId_key" ON "token"("emailId");
